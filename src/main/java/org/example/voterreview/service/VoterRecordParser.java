...
public class VoterRecordParser {
    private static final Pattern ID_PATTERN = Pattern.compile("(?i)(?:epic|voter(?:\\s+id)?)(?: *[:\\-]? *)([A-Z]{1,5}[0-9]{4,}|[A-Z0-9]{6,})");
    private static final Pattern NAME_PATTERN = Pattern.compile("(?i)(?:name|elector(?:'?s)?\\s+name)(?: *[:\\-]? *)([A-Za-z .]+)");
    private static final Pattern RELATION_PATTERN = Pattern.compile("(?i)(?:father|spouse|husband|wife|mother)(?:'?s)?\\s+name(?: *[:\\-]? *)([A-Za-z .]+)");
    private static final Pattern AGE_PATTERN = Pattern.compile("(?i)(?:age|dob|date\\s+of\\s+birth)(?: *[:\\-]? *)([A-Za-z0-9/\\- ]+)");
    private static final Pattern GENDER_PATTERN = Pattern.compile("(?i)(?:gender|sex)(?: *[:\\-]? *)(male|female|other)");
    private static final Pattern ADDRESS_PATTERN = Pattern.compile("(?i)(?:house\\s+no|address)(?: *[:\\-]? *)([A-Za-z0-9,./\\- ]+)");
    private static final Pattern PART_PATTERN = Pattern.compile("(?i)(?:part\\s+no|part number)(?: *[:\\-]? *)([A-Za-z0-9\\-]+)");
    private static final Pattern SERIAL_PATTERN = Pattern.compile("(?i)(?:serial\\s+no|sl\\s*no|serial number)(?: *[:\\-]? *)([A-Za-z0-9\\-]+)");
